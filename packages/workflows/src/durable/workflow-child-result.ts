...
export function parseWorkflowChildResult(
  ...
  if (exited !== true || !isWorkflowExitStatus(status)
    || (exitReason !== undefined && typeof exitReason !== "string")) return undefined;
  return value as WorkflowChildResult<WorkflowOutputValues>;
}
...
function isWorkflowExitStatus(
  value: WorkflowSerializableValue | undefined,
): value is WorkflowExitStatus {
