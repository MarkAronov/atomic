...
```json
{
  ...
  "parameters": {
    ...
    "text": "optional string payload for answer/send/resume; explicit empty text answers pending prompts",
    ...
    "promptId": "optional pending prompt identifier for answer (also accepted by legacy send)",
