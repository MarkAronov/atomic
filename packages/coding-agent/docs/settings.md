...
Automatic subagent and workflow-stage model selection sends the router the complete task; it is never shortened. If a very long task makes the request too large for the selected classifier, routing switches to the current chat model.
